...
servicios['negArchivos'] = require('./servicios/neg_archivos.servicios')(servicios, modelos, Sequelize.Op);
...
require('./controladores/neg_archivos.controlador')(router, servicios);
